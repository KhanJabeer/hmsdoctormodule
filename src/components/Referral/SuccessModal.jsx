                ...
                <Grid container>
                    <Grid item xs={12} md={12} className="media_title_container">
                      <div className="mediadelete_container">
                          <p className="delete_para">Referral has been sent to the Patient and the Doctor</p></div>
                           <div className="mediadelete_container">
                           
                           <Button className="detete_yes"  onClick={()=>this.props.closemodal(false)}>Ok</Button></div>
