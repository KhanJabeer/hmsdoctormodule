      ...
      <TableRow>
        ...
        <TableHead>
            <TableRow
              ...
              tabIndex={-1}
            >
          <TableCell align="right" style={{width:"4vw"}}>Sno</TableCell>
          <TableCell align="right" style={{width:"5vw"}}>From Time</TableCell>
       ...
       store.push(...this.state.doctordetails,
        ...
        <div className="AvailabilityDetailsDiv">
          ...
          <TableCell component="th" id={""} scope="row" padding="none"  style={{width:"10.5vw"}}>
                               ...
                               <TableCell align="right" style={{ width: "11.8vw" }}><Input value={this.state.fromTime} onChange={this.handleChange}  style={{ width: 90 }}/></TableCell>
      ...
      <div className="AvailabilityDetailsDiv" >
          ...
          <div className="tableWrapper">
            ...
            >
              ...
              />
              <TableBody>
                {stableSort(appDetails, getSorting(this.state.order, this.state.orderBy))
                  ...
                  .map((row, index, item) => {
                    ...
                    return (
                      <ScheduleComp {...this.props} index={index} data={row}/>
                    )})
                }
                </TableBody>
                </Table>
