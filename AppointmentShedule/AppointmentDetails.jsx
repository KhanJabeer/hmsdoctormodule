    ...
    <TableHead>
      <TableRow>
        ...
        <TableHead>
          ...
          <TableCell align="right" style={{width:90}}>From Time</TableCell>
          <TableCell align="right" style={{width:90}}>To Time</TableCell>
          <TableCell align="right" style={{width:90}}>Slot Duration</TableCell>
          <TableCell align="right" style={{width:80}}>No. of slots</TableCell>
          <TableCell align="right" style={{width:90}}>Appointment Type</TableCell>
...
export default class Availabilitydetails extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      //                            <Input  name="fromtime" style={{ width: 90 }} onChange={this.handleChange} />
      //                            </TableCell> 

      //                          <TableCell align="right" style={{ width: "15vw" }} >
      //                            <Input  style={{ width: 90 }} /></TableCell>
 
      //                          <TableCell align="right" className="Abi" style={{ width: "15vw" }}>
      //                            <Input  style={{ width: 60 }} /><label className="slot-duration-unit_label">Min</label></TableCell>
      //                          <TableCell align="right" style={{ width: "12vw" }}><div className="no_of_slots_data">{NoOfslots}</div></TableCell>
      //                          <TableCell align="right" style={{ width: "13vw" }}><div >
      //                            <Select className="availability-clinic-toggledropdown" defaultValue="Regular" style={{ width: 110 }} onChange={handleChange}>
      //                            <Option className="availability-clinic-toggledropdown" value="2">Regular</Option>
      //                            <Option className="availability-clinic-toggledropdown" value="1">Vip</Option>
       ...
       store.push(...this.state.doctordetails,
        ...
        <div className="AvailabilityDetailsDiv">
          ...
          <TableCell component="th" id={""} scope="row" padding="none"  style={{width:"9vw"}}>
                               ...
                               <TableCell align="right" style={{ width: "15vw" }}><Input value={this.state.fromTime} onChange={this.handleChange}  style={{ width: 90 }}/></TableCell>

                               <TableCell align="right" style={{ width: "15vw" }} ><Input value={this.state.toTime} style={{ width: 90 }} /></TableCell>
 
                               <TableCell align="right" className="Abi" style={{ width: "15vw" }}>
                                 <Input value={this.state.slotduration} style={{ width: 60 }} /><label className="slot-duration-unit_label">Min</label></TableCell>

                               <TableCell align="right" style={{ width: "12vw" }}><div className="no_of_slots_data"><Input value={this.state.NoOfslots} style={{ width: 60 }} /></div></TableCell>
                               <TableCell align="right" style={{ width: "13vw" }}><div >
                                 <Select className="availability-clinic-toggledropdown" defaultValue="Vip" style={{ width: 110 }} onChange={handleChange}>
      ...
      <div className="AvailabilityDetailsDiv" >
          ...
          <div className="tableWrapper">
            ...
            >
             ...
             {
               <ScheduleComp clinic={this.props.clinic}/>
             }
          </div>
          <TablePagination
